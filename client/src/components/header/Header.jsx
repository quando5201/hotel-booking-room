                ...
                { type !== "list" &&
                    <>
                        ...
                        <p className="headerDesc">
                            ...
                            more with a free QNL Booking account
                        </p>
                                    ...
                                    {openOptions &&<div className="options">
                                        <div className="optionItem">
                                            ...
                                            <div className="optionCounter">
                                                ...
                                                <span className="opntionCounterNuber">{options.adult}</span>
                                        ...
                                        <div className="optionItem">
                                            ...
                                            <div className="optionCounter">
                                                ...
                                                <span className="opntionCounterNuber">{options.children}</span>
                                        ...
                                        <div className="optionItem">
                                            ...
                                            <div className="optionCounter">
                                                ...
                                                <span className="opntionCounterNuber">{options.room}</span>
